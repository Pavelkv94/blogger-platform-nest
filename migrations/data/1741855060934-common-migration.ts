...
export class CommonMigration1741855060934 implements MigrationInterface {
    name = 'CommonMigration1741855060934'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "answer" ("id" SERIAL NOT NULL, "answer" character varying NOT NULL, "status" "public"."answer_status_enum" NOT NULL, "question_id" integer NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "playerId" integer, CONSTRAINT "PK_9232db17b63fb1e94f97e5c224f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "player" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "score" integer NOT NULL DEFAULT '0', "status" character varying, "gameId" character varying, "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_65edadc946a7faf4b638d5e8885" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "question" ("id" SERIAL NOT NULL, "body" character varying COLLATE "C" NOT NULL, "correctAnswers" jsonb NOT NULL, "published" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."game_gamestatus_enum" AS ENUM('PENDING_SECOND_PLAYER', 'ACTIVE', 'FINISHED')`);
